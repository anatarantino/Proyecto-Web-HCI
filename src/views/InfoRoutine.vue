    ...
    <v-row class="mt-8">
      <v-col cols="6">
        <v-row class="align-center justify-center  mb-2">
          <v-col cols="6">
            <div
              class="align-center rounded-xl grey darken-1 white--text"
              centered
            >
              <p class="text-center">
                Entrada en calor
      ...
      <v-col cols="6" class="justify-center">
        ...
        <v-row class="align-center">
          <v-col cols="4" >
            <v-row align="center" class="white pa-0 rounded-l">
              <h2 class="ml-2"> Dificultad </h2>
              <v-list>
                <v-list-item>
                  <v-list-item-title>
                    <v-icon color="orange" v-for="dif in 2" :key="dif">
                      mdi-fire
                    </v-icon>
                  </v-list-item-title>
                </v-list-item>
          ...
          <v-col cols="4">
            <v-row align="center" class="white pa-0  rounded-r">
              ...
              <v-list>
                <v-list-item>
                  <v-list-item-title>
                    <v-icon color="rgb(255,254,0)" v-for="dif in 5" :key="dif">
                      mdi-star
                    </v-icon>
                  </v-list-item-title>
                </v-list-item>
            ...
            <v-card>
              ...
              <v-card-text>
                <p> Con el entrenamiento con cuerdas durante
                    una sesión de duro trabajo se pueden
                    llegar a quemar entre 300 y 500 calorías
